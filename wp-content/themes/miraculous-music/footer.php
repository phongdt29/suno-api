                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <?php else : ?>
                            <div class="footer_box footer_app">
                                <h1 class="footer_title"><?php esc_html_e('Download our App', 'miraculous-music'); ?></h1>
                                <p><?php esc_html_e('Go Mobile with our app. Listen to your favourite songs at just one click. Download Now!', 'miraculous-music'); ?></p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <?php else : ?>
                            <div class="footer_box footer_subscribe">
                                <h1 class="footer_title"><?php esc_html_e('subscribe', 'miraculous-music'); ?></h1>
                                <p><?php esc_html_e('Subscribe to our newsletter and get latest updates and offers.', 'miraculous-music'); ?></p>
                                <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                                    <input type="hidden" name="action" value="newsletter_subscribe">
                                    <?php wp_nonce_field('newsletter_subscribe', 'newsletter_nonce'); ?>
                                    <div class="form-group">
                                        <input type="text" name="subscriber_name" class="form-control" placeholder="<?php esc_attr_e('Enter Your Name', 'miraculous-music'); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" name="subscriber_email" class="form-control" placeholder="<?php esc_attr_e('Enter Your Email', 'miraculous-music'); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ms_btn"><?php esc_html_e('sign me up', 'miraculous-music'); ?></button>
                                    </div>
                                </form>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <?php else : ?>
                            <div class="footer_box footer_contacts">
                                <h1 class="footer_title"><?php esc_html_e('contact us', 'miraculous-music'); ?></h1>
                                <ul class="foo_con_info">
                                    <li>
                                        ...
                                        <div class="foo_con_data">
                                            <span class="con-title"><?php esc_html_e('Call us :', 'miraculous-music'); ?></span>
                                    ...
                                    <li>
                                        ...
                                        <div class="foo_con_data">
                                            <span class="con-title"><?php esc_html_e('email us :', 'miraculous-music'); ?></span>
                                    ...
                                    <li>
                                        ...
                                        <div class="foo_con_data">
                                            <span class="con-title"><?php esc_html_e('walk in :', 'miraculous-music'); ?></span>
                                            <span><?php echo get_theme_mod('contact_address', '598 Old House Drive, London'); ?></span>
                                        </div>
                                    </li>
                                </ul>
                                <div class="foo_sharing">
                                    <div class="share_title"><?php esc_html_e('follow us :', 'miraculous-music'); ?></div>
                                    <ul>
